...
function defaultStyle() {
  imgOneEl.style.boxShadow = '0 12px 5px rgb(0, 0, 0, 0.23)';
  ...
  if (e.target) {
    ...
    for(var j = 0; j < options.length; j ++) {
      if(options[0].checked) {
        ...
        imgOneEl.style.filter = 'brightness(90%)';
      }
      if(options[1].checked) {
        ...
        imgTwoEl.style.filter = 'brightness(90%)';
        imgTwoEl.style.margin = '0 0 -5px 0';
      }
      if(options[2].checked) {
        imgThreeEl.style.boxShadow = '0 12px 5px rgb(0, 0, 0, 0.23)';
        ...
        imgThreeEl.style.filter = 'brightness(90%)';
